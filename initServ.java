...
import protocal.anarres.dhcp.common.address.NetworkAddress;
import protocal.apache.directory.server.dhcp.io.DhcpInterfaceManager;
import protocal.apache.directory.server.dhcp.messages.HardwareAddress;
import protocal.apache.directory.server.dhcp.service.AbstractDhcpService;
import protocal.apache.directory.server.dhcp.service.DhcpService;
import protocal.apache.directory.server.dhcp.service.manager.LeaseManager;
import protocal.apache.directory.server.dhcp.service.store.FixedStoreLeaseManager;
import protocal.apache.directory.server.dhcp.service.store.SimpleStoreLeaseManager;
import server.apache.directory.server.dhcp.netty.DhcpServer;
...
public class initServ {
	public static final String INTERFACE_NAME = "eth1";
...
//			server.addInterfaces(new DhcpInterfaceManager.NamedPredicate(INTERFACE_NAME));
			...
			SimpleStoreLeaseManager leaseManager = new SimpleStoreLeaseManager();
	 ...
	 */
	@Nonnull
	public static FixedStoreLeaseManager newLeaseManager(@Nonnull String interfaceName) throws Exception {
